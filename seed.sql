...
-- insert menus
INSERT INTO menus (id, sort, menu_name, icon, status, created_at, created_by, updated_at, updated_by) VALUES('334aac37-75a4-4468-9a1c-8c645c7b8994'::uuid, 1, 'หน้าหลัก', NULL, 'active', NULL, NULL, NULL, NULL);
INSERT INTO menus (id, sort, menu_name, icon, status, created_at, created_by, updated_at, updated_by) VALUES('9df17eb7-e238-4709-b22b-56d11c202ed5'::uuid, 2, 'ตั้งค่าโปรไฟล์', NULL, 'active', NULL, NULL, NULL, NULL);
INSERT INTO menus (id, sort, menu_name, icon, status, created_at, created_by, updated_at, updated_by) VALUES('ddb3ffc3-c01b-4c6d-a4d5-b42aa53f9684'::uuid, 3, 'ประวัติการแชท', NULL, 'active', NULL, NULL, NULL, NULL);
INSERT INTO menus (id, sort, menu_name, icon, status, created_at, created_by, updated_at, updated_by) VALUES('834e997c-cfd1-41c5-924a-1b9c4b87b7c6'::uuid, 4, 'ไฟล์พื้นฐาน', NULL, 'active', NULL, NULL, NULL, NULL);
INSERT INTO menus (id, sort, menu_name, icon, status, created_at, created_by, updated_at, updated_by) VALUES('eb995e01-6b27-46e3-9dae-e361aad1095d'::uuid, 5, 'ข้อมูลพื้นฐาน', NULL, 'active', NULL, NULL, NULL, NULL);
INSERT INTO menus (id, sort, menu_name, icon, status, created_at, created_by, updated_at, updated_by) VALUES('bd15c30e-8d44-4bc5-a68f-62884f6ccabc'::uuid, 6, 'ตั้งค่าผู้ใช้งาน', NULL, 'active', NULL, NULL, NULL, NULL);
INSERT INTO menus (id, sort, menu_name, icon, status, created_at, created_by, updated_at, updated_by) VALUES('aab55fd6-b9ff-486e-823d-d1b5d451bc51'::uuid, 7, 'ตั้งค่าบทบาท', NULL, 'active', NULL, NULL, NULL, NULL);
